...
const defaultValues = {
  ...
  displayOrder: 0,
  isActive: true,
  teamType: TEAM_TYPES.BOARD
}

const DirectorFormDialog = ({ open, director, onSave, onClose, saving }) => {
  ...
  const onSubmit = ({ teamType, ...data }) => {
    ...
    // teamType is not a Director field — a change to it is a move between
    // collections, handled by the transfer endpoint rather than the update.
    const targetTeam = isEdit && teamType !== TEAM_TYPES.BOARD ? teamType : null
      ...
      <DialogContent dividers>
        <Grid container spacing={2} sx={{ pt: 1 }}>
                ...
                <TextField
                  ...
                  helperText={
                    ...
                    (isEdit
                      ...
                      : 'The member is added to the Board of Directors. You can move them after saving.')
                  }
                >
          ...
          <Grid item xs={12}>
            <ImageUpload
              label="Photo"
              currentImageUrl={director?.photo?.url || ''}
