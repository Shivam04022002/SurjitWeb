...
// ── Website analytics ──────────────────────────────────────────────────────────
// Anonymous page-view beacon from the public site. No IP or user-agent string
// is stored; the session id is generated by the browser for itself. Rate
// limited so the collection cannot be flooded from one source.
router.post(
    '/analytics/track',
